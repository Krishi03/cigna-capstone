                ...
                <div className="p-6">
                  ...
                  <div className="flex space-x-2 pt-4 border-t border-slate-200">
                    <button
                      ...
                      className="flex-1 flex items-center justify-center space-x-1 px-4 py-2 bg-emerald-50 text-emerald-600 rounded-lg hover:bg-emerald-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      <Edit className="h-4 w-4" />
                      <span>Edit</span>
                    </button>
                    <button
                      onClick={() => handleDeleteClaim(claim.claimId, claim.status)}
                      disabled={claim.status === 'Approved' || claim.status === 'Rejected'}
